...
export const CONTACT_ROLE_OPTIONS = [
  ...
  { value: "Listing Agent Team Member/Assistant", label: "Listing Agent Team Member/Assistant" },
  { value: "Buyer's Agent Team Member/Assistant", label: "Buyer's Agent Team Member/Assistant" },
...
export const LEGACY_CONTACT_ROLE_REMAP: Record<string, string> = {
  ...
  "Listing Agent's Assistant": "Listing Agent Team Member/Assistant",
  "Buyer's Agent's Assistant/Team Member": "Buyer's Agent Team Member/Assistant",
  Lender: "Lender",
