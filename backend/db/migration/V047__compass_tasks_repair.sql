-- Repair: V045/V046 may be recorded in schema_migrations without columns/templates applied
-- (e.g. restored DB, wrong target, or interrupted deploy). All statements are idempotent.
